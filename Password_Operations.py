...
def password_operations():
    ...
    bckgrnd_img1 = open_image('dark.png')
    ...
    def generate_password():
        ...
        try:
            ...
            messagebox.showerror("Error", "Please enter a numeric password length")
            return
    ...
    backgroundimage = open_image("password.jpg")
    # resize the image
    ...
    backgroundimage2 = open_image("file.png")
    # resize image
    ...
    backgroundimage1 = open_image("passwd.png")
